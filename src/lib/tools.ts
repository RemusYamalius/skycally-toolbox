...
export const tools: Tool[] = [
  ...
  { slug: "space-shooter", name: "Space Shooter", description: "Destroy alien ships and survive the galaxy!", category: "minigames", icon: Rocket, path: "/tools/space-shooter" },
  ...
  { slug: "weather-checker", name: "Weather Checker", description: "Check live weather for any city — current conditions, 24-hour forecast, 7-day outlook, UV index, air quality, sunrise and sunset times. Free, no signup.", category: "utility", icon: CloudSun, path: "/tools/weather-checker" },
