      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            description:
              "Free time zone converter with a live world clock and remote-team meeting planner. Convert time between 90+ cities instantly, no signup.",
            applicationCategory: "UtilitiesApplication",
            operatingSystem: "Any",
            url: `${SITE_URL}/tools/time-zone-converter`,
            offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
            featureList: [
              "Convert time instantly between 90+ cities worldwide",
              "Live, second-by-second clocks with UTC offset and timezone abbreviation",
              "World Clock dashboard for up to 12 saved cities with day/night indicators",
              "Meeting Planner for up to 5 participants, finding the window where everyone is in working hours",
              "Automatic daylight saving time handling via the Intl API",
              "Convert any specific time, not just the current time",
              "No signup — city selections saved locally in your browser",
            ],
          }),
        },
      ],
...
const SEO_FAQS = [
  {
    question: "How do I convert time between two cities?",
    answer:
      "Select your origin city in the FROM field and your destination city in the TO field using the searchable dropdown. Both clocks update instantly to show the current live time in each location. To convert a specific time rather than the current time, enter it in the time input field below the clocks and the converted result appears immediately.",
  },
  {
    question: "What is the difference between UTC, GMT, and local time?",
    answer:
      "UTC (Coordinated Universal Time) is the global time standard that all other time zones are measured against. GMT (Greenwich Mean Time) is the time zone of London in winter and is effectively equivalent to UTC. Local time is the current time in a specific location, which may differ from UTC by a positive or negative offset — for example, New York is UTC-5 in winter and UTC-4 in summer (daylight saving time).",
  },
  {
    question: "How many cities are available in the converter?",
    answer:
  ...
  {
    question: "What is the Meeting Planner and how does it work?",
    answer:
      "The Meeting Planner helps remote teams find a time that works for participants across multiple time zones. Add up to five cities representing your team members, and the tool generates a 24-hour schedule table showing what time it would be in each city for every hour of the day. Ideal business hours (9 AM to 6 PM) are highlighted in green, and the tool automatically identifies the best window where every participant, not just most of them, falls within working hours.",
  },
  {
    question: "Does the converter account for daylight saving time?",
    answer:
      "Yes. The converter uses the browser's built-in Intl (Internationalization) API, which automatically applies the correct daylight saving time rules for each timezone based on the current date. This means conversions are always accurate regardless of whether a location is currently observing DST or standard time.",
  },
  {
    question: "Can I save my favourite cities to the world clock?",
    answer:
      "Yes. The World Clock section allows you to add up to 12 cities by clicking the Add City button. Your selected cities are saved in your browser's local storage, so they are automatically restored the next time you visit. You can remove any city at any time using the Edit mode.",
  },
  {
    question: "What does the day/night indicator mean?",
    answer:
      "Each city card in the World Clock shows an emoji indicating the approximate time of day in that location: 🌄 Dawn (5-8 AM), 🌅 Morning (8-12 PM), ☀️ Afternoon (12-5 PM), 🌇 Evening (5-8 PM), or 🌙 Night (8 PM-5 AM). Cards are also colour-tinted — warm amber for daytime and cool blue for night — giving an instant visual overview of who is awake around the world.",
  },
  {
