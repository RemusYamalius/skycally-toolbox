    ...
    <ToolPageShell title="JSON Formatter" description="Format, prettify and minify JSON instantly.">
      ...
      <ToolSeoContent
        ...
        body={[
          ...
          "This tool is commonly used to inspect API responses copied from browser DevTools, tidy up a config file before committing it, or turn a wall of minified JSON from a third-party service into something readable enough to actually understand. Since everything runs locally, it's also safe to paste in JSON containing API keys or other sensitive data during debugging — nothing is sent anywhere.",
        ]}
        faqs={[
          {
