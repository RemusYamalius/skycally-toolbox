...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    dateAdded: "2026-07-31",
    featureList: [
      "Standard fixed-payment amortization (PMT formula)",
      "Graduated repayment that starts at half the standard payment and steps up every two years",
      "Income-Driven Repayment modeled on the SAVE formula (225% poverty-line protection, 5% of discretionary income)",
      "SAVE unpaid-interest waiver so the balance never grows",
      "Estimated forgiveness amount after 20 years on IDR",
      "Side-by-side comparison of all three plans: monthly, total paid, total interest and payoff time",
      "Repayment terms of 10, 20, 25 or 30 years",
      "Cumulative principal vs interest area chart with clickable legend",
      "Full month-by-month amortization schedule with show-all toggle",
      "Instant results as you type",
      "No signup required",
      "100% browser-based",
    ],
  ...
  },
  {
    ...
    name: "Purity Test",
    description:
      "Check off which of 100 life experiences apply to you and get your score instantly — free, private, no signup.",
    category: "games",
    icon: Feather,
    path: "/tools/purity-test",
    dateAdded: "2026-08-05",
    featureList: [
      "100 original life-experience statements",
      "7 themed categories with quick-skim headings",
      "Custom checkbox list with a sticky live counter",
      "Instant score: the percentage you left unchecked",
      "7 result tiers with emoji, label and blurb",
      "Copyable result card and one-tap WhatsApp share",
      "Nothing saved — no account, no storage, no tracking",
  ...
  },
  {
    ...
    name: "Most Likely To",
    description:
      "Draw a 'most likely to' card, point at the guilty person, and watch friendships get tested. 200+ questions across 6 categories.",
    category: "games",
    icon: Users2,
    path: "/tools/most-likely-to",
    dateAdded: "2026-07-31",
    featureList: [
      "200 original Most Likely To questions",
      "6 category filters: Funny, Party, School, Relationships, Bold, Wholesome",
      "No-repeat shuffle until the whole pool is used",
      "Gradient cards styled per category",
      ...
      "Session counter and one-tap share text",
