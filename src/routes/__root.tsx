...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free online tools: video downloader, image converter, PDF tools, background remover and more. No registration required." },
      { property: "og:title", content: "Skycally — Every tool you need, one place" },
      { property: "og:description", content: "Free online tools: video downloader, image converter, PDF tools, background remover and more. No registration required." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Skycally — Every tool you need, one place" },
      { name: "twitter:description", content: "Free online tools: video downloader, image converter, PDF tools, background remover and more. No registration required." },
