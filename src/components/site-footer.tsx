...
const categoryOrder: ToolCategory[] = ["ai", "video", "image", "audio", "pdf", "text", "utility"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid gap-10 md:grid-cols-4">
        <div>
          <Link to="/" className="flex items-center">
            <img src="/logo.webp" alt="Skycally" width="171" height="30" decoding="async" loading="lazy" style={{ height: "30px", width: "auto" }} />
          </Link>
