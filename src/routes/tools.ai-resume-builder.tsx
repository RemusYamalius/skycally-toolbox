      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            description:
              "Free AI resume builder. ATS-optimized resumes in seconds, in English, French, Spanish, German or Arabic. No signup, no daily limits.",
            applicationCategory: "UtilitiesApplication",
            operatingSystem: "Any",
            url: `${SITE_URL}/tools/ai-resume-builder`,
            offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
            featureList: [
              "AI-generated, ATS-optimized resumes tailored to a specific job description",
              "4 tone options and 3 length options",
              "5 languages: English, French, Spanish, German, Arabic",
              "Quantified, action-verb-driven achievement bullets",
    ...
    <ToolPageShell title={tool.name} description={tool.description} showFileDisclaimer={false}>
      ...
      {resume && !loading && (
        <section className="mt-6 rounded-2xl border border-border bg-card/40 p-5 text-sm text-muted-foreground space-y-2">
          ...
          <p>
            Sending it with a follow-up note? Draft one with the{" "}
            <Link
            ...
            . Checking your resume's length? Use the{" "}
            <Link
