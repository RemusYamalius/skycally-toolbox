...
const TRUTHS = [
  ...
  "What's the cruelest thing you've ever said about someone?",
  "What's a habit you have that you'd never admit in public?",
  "Who in this group would you trust with your darkest secret — and why?",
  "What's the most jealous you've ever been?",
  "Have you ever pretended to be sick to avoid someone? What happened?",
  ...
  "What's something you like that everyone else seems to hate?",
  ...
  "Have you ever cried during a movie you were embarrassed to cry at?",
  "What's the most childish thing you do when you're alone?",
  "What's a rumor you helped spread that turned out to be false?",
  "What's the strangest thing you've eaten when no one was watching?",
  "Have you ever laughed at completely the wrong moment?",
  "What's the most embarrassing search in your browser history?",
  ...
  "What's the most unflattering photo of yourself that you secretly like?",
  "What's the biggest secret you've kept from your best friend?",
  "What's the most ridiculous thing you've convinced yourself was true?",
  "Have you ever been caught talking to yourself?",
  "What's the most embarrassing outfit you've worn in public?",
  "What's a weird food combination you genuinely enjoy?",
  "Have you ever pretended to know a song just to fit in?",
  "What's the most dramatic overreaction you've ever had?",
...
const DARES = [
  ...
  "Let someone in the group send one emoji to anyone in your contacts.",
  "Do your best impression of a news anchor reporting on something silly.",
  "Switch seats with every player at the table before your next turn.",
  "Give a dramatic motivational speech about something completely random.",
  "Speak in a whisper while standing on one leg for 1 minute.",
  "Let the group choose a word you're not allowed to say for the rest of the game.",
  "Do a dramatic soap-opera reaction to the next thing someone says to you.",
  "Act out your morning routine without using any words.",
  "Text someone you haven't talked to in over a year just to say hi.",
  "Let the group create a group chat name and you keep it for a week.",
  "Do 15 squats while humming a tune the group picks.",
  ...
  "Let the group give you a temporary tattoo using a pen on your arm.",
  "Walk like a crab across the room and back.",
  "Sing the alphabet backwards as fast as you can.",
  "Let someone choose your next social media post caption.",
  "Pretend you just won an Oscar and give a full acceptance speech.",
  "Do 5 yoga poses the group names for you — or your best guesses.",
  "Talk in the third person about yourself for the next 3 rounds.",
  "Let the group pick a song you have to hum instead of speaking for the next round.",
  "Strike a dramatic superhero pose and hold it for 15 seconds.",
  "Do an exaggerated mime of your favorite hobby without any props.",
];
