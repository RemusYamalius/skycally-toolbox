...
const CAPITALS: Record<string, [number, number]> = {
  ...
  CH: [46.948, 7.4474], AT: [48.2082, 16.3738], SE: [59.3293, 18.0686],
  ...
  BG: [42.6977, 23.3219], GR: [37.9838, 23.7275], RS: [44.7866, 20.4489],
  HR: [45.815, 15.9819], SI: [46.0569, 14.5058], UA: [50.4501, 30.5234],
  BY: [53.9006, 27.5590], LT: [54.6872, 25.2797], LV: [56.9496, 24.1052],
  EE: [59.4370, 24.7536], RU: [55.7558, 37.6173],
  TR: [39.9334, 32.8597], IL: [31.7683, 35.2137], SA: [24.7136, 46.6753],
  AE: [24.4539, 54.3773], EG: [30.0444, 31.2357], MA: [34.0209, -6.8417],
  DZ: [36.7538, 3.0588], TN: [36.8065, 10.1815], LY: [32.8872, 13.1913],
  JO: [31.9454, 35.9284], LB: [33.8938, 35.5018], SY: [33.5138, 36.2765],
  IQ: [33.3152, 44.3661], IR: [35.6892, 51.3890], QA: [25.2854, 51.5310],
  KW: [29.3759, 47.9774], YE: [15.3694, 44.1910],
  ...
  IN: [28.6139, 77.2090], PK: [33.6844, 73.0479], BD: [23.8103, 90.4125],
  LK: [6.9271, 79.8612], NP: [27.7172, 85.3240], ID: [-6.2088, 106.8456],
  TH: [13.7563, 100.5018], VN: [21.0285, 105.8542], PH: [14.5995, 120.9842],
  MY: [3.139, 101.6869], SG: [1.3521, 103.8198], TW: [25.0330, 121.5654],
  HK: [22.3193, 114.1694], KH: [11.5564, 104.9282], MM: [16.8409, 96.1735],
  AU: [-35.2809, 149.13], NZ: [-41.2865, 174.7762],
};
