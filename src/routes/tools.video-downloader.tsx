    ...
    <ToolPageShell title="Video Downloader" description="Download videos from popular platforms.">
      <div className="rounded-2xl border border-border bg-card p-8 text-center space-y-4">
        ...
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          The video downloader relied on a backend service that has been retired. This tool is currently offline. In the
      ...
      <ToolSeoContent
        ...
        description={
          "Skycally's video downloader is temporarily unavailable while we move to a fully browser-based pipeline."
        }
        body={[
        ...
        faqs={[
          {
            question: "When will the video downloader come back?",
            answer: "We're working on a fully browser-based replacement. No date yet — check back soon.",
          },
          {
            question: "Why was it taken offline?",
            answer:
              "The backend service it relied on has been retired so we can focus on tools that run entirely on your device.",
          },
          {
            question: "Can I still process my own video files?",
            answer:
              "Yes — every other video tool on Skycally runs locally in your browser and works with files already on your device.",
          },
          {
            question: "Will downloads work on mobile when it returns?",
            answer: "Yes, the replacement is being designed to work on both desktop and mobile browsers.",
          },
        ]}
      />
