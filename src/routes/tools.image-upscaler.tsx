    ...
    >
      ...
      <ToolSeoContent
        ...
        body={[
          ...
          "Lanczos3 resampling works best on images that are already reasonably sharp — it enhances and preserves existing detail rather than inventing new detail the way AI super-resolution models attempt to. For heavily blurred or very low-resolution source images, results will still look noticeably better than a naive resize, but won't recover detail that was never captured in the original photo.",
        ]}
        faqs={[
          {
